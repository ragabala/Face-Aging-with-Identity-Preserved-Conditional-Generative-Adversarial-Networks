...
project_folder = '/home/ragbalak/Ragadocs/NCSU docs/Neural Networks/Final Project/Face-Aging-with-Identity-Preserved-Conditional-Generative-Adversarial-Networks-master/'
...
flags.DEFINE_string("alexnet_pretrained_model", project_folder+"checkpoints/pre_trained/alexnet/alexnet.model-292000",
                    "Directory name to save the checkpoints")

flags.DEFINE_string("age_pretrained_model", project_folder+"checkpoints/pre_trained/age_classifier/age_classifier.model-300000",
                    "Directory name to save the checkpoints")
...
flags.DEFINE_string("source_file", project_folder+'Data/training_file.txt', "source file path")

flags.DEFINE_string("root_folder", project_folder+'Data/CACDTop100/', "folder that contains images")
